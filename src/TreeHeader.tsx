...
export const TreeHeader = ({ insertionHandler, deletionHandler, resetHandler, treeType, setTreeType }: Props) => {
  ...
  return (
    <div className="flex justify-between">
      <div className="text-4xl m-4 font-mono">
        B-Baum-Zeichner
      </div>
      <div className="flex flex-col items-end">
        <form className="">
          <input className="p-1 w-20 border-2 rounded-lg border-gray-500" type="text" maxLength={5} value={insertValue} onChange={handleInsertionInput} />
          ...
          <input className="p-1 w-20 border-2 rounded-lg border-gray-500" type="text" maxLength={5} value={deletionValue} onChange={handleDeletionInput} />
